...
export const NewPlanArea: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Firestoreのusersコレクションから現在のユーザーのドキュメントを取得
      ...
      // ドキュメント内のuserIdフィールドを取得
      const userData = userDocSnap.data();
      const currentUserId = userData.userId;

      // 作成時に、現在のユーザーのuserIdをsharedWithに追加
      const updatedSharedWith = [...sharedWith, currentUserId];
            ...
            <Stack spacing={2}>
              ...
              <Accordion>
                <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                  <Typography sx={{ color: "text.primary" }}>訪問先</Typography>
                </AccordionSummary>
                <AccordionDetails>
